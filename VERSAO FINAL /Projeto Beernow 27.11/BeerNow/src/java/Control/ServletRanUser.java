...
public class ServletRanUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //  String action = request.getParameter("action");
        ...
        {
            adiciona.append("<tr><td>").append(lcli.get(i).getUsername()).append("</td>");
            adiciona.append("<td>").append(lcli.get(i).getRanking()).append("</td>"); 
            if(i == 0){
                adiciona.append("<td> O pika das galáxias </td>");
            }
            if(i == 1){
                adiciona.append("<td> O rei da cerveja </td>");
            }
            if(i == 2){
                adiciona.append("<td> O rei do camarote </td>");
            }
            if(i >= 3){
                adiciona.append("<td> Poser! </td></tr>");
            }
        }
